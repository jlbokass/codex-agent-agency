...
This script uses GitHub CLI to create a repository, add the remote, and push the
current branch with upstream tracking. It never stores credentials. GitHub CLI
