...
Options:
  --project-dir       Existing generated project directory. Required.
  --initial-branch    Initial branch name. Defaults to main.
  --commit-message    Initial commit message. Defaults to "Initial commit".
  --help              Show this help message.

This script initializes a local Git repository and creates the initial commit.
It does not create GitHub repositories, configure remotes, push code, or store
credentials.
USAGE
}
