...
The `scaffolds/` directory will contain reusable generated-code templates.
Scaffolds are starter code structures or project fragments that can be copied,
adapted, or generated into another repository.
