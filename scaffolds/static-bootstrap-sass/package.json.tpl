{
  ...
  "scripts": {
    ...
    "serve": "browser-sync start --server public --files \"public/**/*.html, assets/css/**/*.css, assets/js/**/*.js\" --no-open",
    "watch:scss": "sass --watch src/scss/main.scss:assets/css/main.css --style=expanded --source-map",
